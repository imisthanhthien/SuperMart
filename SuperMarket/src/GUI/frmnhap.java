...
public class frmnhap extends javax.swing.JFrame {
 private ArrayList<CTPhieuNhap> listCTPhieuNhap = null;
     ...
     * @param nhaCungCap
     * @param nhanVien
     * @param listCTPhieuNhap
     */
    public frmnhap(String nhaCungCap, String nhanVien, ArrayList<CTPhieuNhap> listCTPhieuNhap) {
    ...
    private void btnXacNhanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnXacNhanActionPerformed
       ...
       ArrayList<HangHoa> dssp = hhbus.getListSanPham();
        ...
        hd +="</div>";
        hd += "<h1 style='text-align:center;font-size:20px;'>PHIẾU NHẬP HÀNG</h1>";
   
        hd += " <div style=\"text-align: left;\">";
        hd += "  <span>Nhân viên nhập: </span>" + nhanVien+ "<br/>";
        hd += " <span>Ngày lập: </span>" + dtf.format(now) + "<br/>";
        hd += "<span>Nhập từ nhà cung cấp: </span>"+ nhaCungCap + "<br/>";
        hd += "  </div>";
        ...
        for (CTPhieuNhap ctpn : listCTPhieuNhap) {
            hd += "<tr>";
            hd += "<td style='text-align:center;'>" + ctpn.getMaHH() + "</td>";
            for (HangHoa sp : dssp) {
                if (sp.getMaHH() == ctpn.getMaHH()) {
                    hd += "<td style='text-align:left;'>" + sp.getTenHH() + "</td>";
                    break;
                }
            }
            hd += "<td style='text-align:left;'>" + ctpn.getSoluongNhap() + "</td>";
            hd += "<td style='text-align:left;'>" + dcfx.format(ctpn.getGiaNhap()) + "</td>";
            hd += "<td style='text-align:left;'>" + dcfx.format(ctpn.getThanhtien()) + "</td>";
            hd += "</tr>";
